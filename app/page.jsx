      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy reveal">
          ...
          <div className="hero-actions">
            ...
            <a className="button button-secondary" href="/Syed_Zaid_Ali_Resume.pdf?v=20260723-3" target="_blank" rel="noreferrer">View résumé <span>↗</span></a>
          </div>
        ...
        <div className="hero-proof reveal delay-1">
          <div className="portrait-shell">
            <img
              ...
              decoding="async"
              fetchPriority="high"
              src="/images/zaid-backend-engineer.png?v=20260714-2"
            />
